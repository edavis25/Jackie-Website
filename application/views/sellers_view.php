...
<div class="container">
    ...
    <div class="row row-fluid">
        ...
        <div class="col-md-8 col-md-pull-4">
            <div class="row">
                <h1><i>Frequently Asked Questions<br /> for <b>Sellers</b></i></h1>
                <hr />
                ...
                <div class="panel-group">
                    <div class="panel panel-default">
                        <a data-toggle="collapse" href="#collapse3">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    Getting Your Home Ready to Sell<span class="glyphicon glyphicon-plus float-right hidden-xs"></span>
                                </h4>
                            </div>
                        </a>
                        <div id="collapse3" class="panel-collapse collapse">
                            <div class="panel-body">
                                <h4><b>Getting Your Home Ready to Sell</b></h4>
                ...
                <div class="panel-group">
                    <div class="panel panel-default">
                        <a data-toggle="collapse" href="#collapse4">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    Tips for Open House &amp; Showings<span class="glyphicon glyphicon-plus float-right hidden-xs"></span>
                                </h4>
                            </div>
                        </a>
                        <div id="collapse4" class="panel-collapse collapse">
                            <div class="panel-body">
                                <h4><b>Tips for Open House &amp; Showings</b></h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ornare pellentesque metus, id malesuada nunc ultrices at. Aliquam id nulla non lorem hendrerit elementum a vitae sem. Praesent accumsan ornare erat, ac convallis lacus facilisis quis. Morbi vitae est turpis. Integer purus magna, ornare vel egestas sed, porta id orci. Sed a felis in libero fermentum mollis in in odio. Vestibulum vehicula ante eros, quis ornare nunc eleifend ut. Interdum et malesuada fames ac ante ipsum primis in faucibus. Curabitur luctus cursus interdum. </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel-group">
                    <div class="panel panel-default">
                        <a data-toggle="collapse" href="#collapse5">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    Estimating the Value of your Home<span class="glyphicon glyphicon-plus float-right hidden-xs"></span>
                                </h4>
                            </div>
                        </a>
                        <div id="collapse5" class="panel-collapse collapse">
                            <div class="panel-body">
                                <h4><b>Estimating the Value of your Home</b></h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ornare pellentesque metus, id malesuada nunc ultrices at. Aliquam id nulla non lorem hendrerit elementum a vitae sem. Praesent accumsan ornare erat, ac convallis lacus facilisis quis. Morbi vitae est turpis. Integer purus magna, ornare vel egestas sed, porta id orci. Sed a felis in libero fermentum mollis in in odio. Vestibulum vehicula ante eros, quis ornare nunc eleifend ut. Interdum et malesuada fames ac ante ipsum primis in faucibus. Curabitur luctus cursus interdum. </p>
                            </div>
                        </div>
                    </div>
